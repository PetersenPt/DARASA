...
- **Game**
- **GameCompany**
- **GameEnterpriseAdvert**
- **GameEnterpriseAdvertAppearance**
- **User**
...
- **API.DARASA**
	...
	- **GetCasa**: GET `/casa`
	- **GetCasaAdverts**: GET `/casaadverts`
	- **GetEnterpriseAdverts**: GET `/enterpriseadverts`
	- **GetEnterprises**: GET `/enterprises`
	- **GetGameCompanies**: GET `/gamecompanies`
	- **GetGameEnterpriseAdvertAppearances**: GET `/gameenterpriseadvertappearances`
	- **GetGameEnterpriseAdverts**: GET `/gameenterpriseadverts`
	- **GetGames**: GET `/games`
	- **GetUsers**: GET `/users`
